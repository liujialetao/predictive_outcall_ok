...
from continuous_request.func import create_some_customers
...
def simulation(customer_num, next_time_create_customer, init_customer_wait_time, F, G):
    ...
    while((manage_customers.all_customers==[]) or (manage_customers.all_customers[-1].customer_id < customer_num)):
        ...
        print('check_idle_time:',check_idle_time)
        # 更新当前坐席的忙碌空闲状态
        ...
        if manage_seats.have_idle_seat==True:
            print('manage_seats.have_idle_seat',manage_seats.have_idle_seat)
            ...
            while the_most_urgent_customer==None:
                # 产生客户
                create_some_customers(num_of_concurrent=1,
                ...
                # 计算拨号周期
                if len(manage_customers.all_customers) <= 20000:
                    ...
                    if new_flag != old_flag:
                        wait_time = cal_wait_time(manage_customers.all_customers, manage_seats, args.H, F, G)
                        old_flag = new_flag
            ...
            if the_most_urgent_customer!=None:
                ...
                print('不可能有更提前的人工坐席需求', ' next_time_create_customer={}'.format(need_artificial_time))
                ...
                if need_artificial_time <= next_time_create_customer:
                    ...
                    if avalable_arificial_time <= need_artificial_time:
                        ...
                        # 监听结束后，客户已经挂机
                            ...
                            # the_most_urgent_customer.monitor_time_duration = monitor_time_duration
                            the_most_urgent_customer.monitor_time_duration = Duration(start_time=monitor_time_duration.start_time, end_time=the_most_urgent_customer.customer_tolerance_duration.end_time)
                ...
                print('结尾', 'manage_seats.have_idle_seat',manage_seats.have_idle_seat)
...
if __name__ == '__main__':
    ...
    for customer_num in [5000]:
        for F in [0.4, 0.6, ]:#0.8, 1, 1.2
            for G in [0, 1, 2,]:# 3, 4, 5, 6
                ...
                call_loss_ration, average_artificial_time_cal, busy_ration1, busy_ration2, average_idle_time1, average_idle_time2, average_dial_interval = simulation(customer_num, next_time_create_customer, init_customer_wait_time, F, G)
    ...
    df_filename = 'mode1_1300_test1.csv'
